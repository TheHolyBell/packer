...
func TestHexChunk_ToBinary(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "base test",
			hc:   HexChunk("FF"),
			want: BinaryChunk("11111111"),
		},
		{
			name: "base test 2",
			hc:   HexChunk("8D"),
			want: BinaryChunk("10001101"),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestHexChunks_ToBinary(t *testing.T) {
	tests := []struct {
		...
		{
			name: "base test",
			hcs:  HexChunks{"CA", "FE", "BA", "BE"},
			want: BinaryChunks{"11001010", "11111110", "10111010", "10111110"},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestBinaryChunks_Join(t *testing.T) {
	tests := []struct {
		...
		{
			name: "base test",
			bcs:  BinaryChunks{"00001111", "10101010", "11001100", "11100011"},
			want: "00001111101010101100110011100011",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
